document.addEventListener("DOMContentLoaded", function() {
    ...
    function ajustarLayout() {
        ...
        const projetos = [
            { nome: "Projeto Casa do Lago", descricao: "Projeto de treinamento da Growarq", imagem: "assets/Casa do lago.png", link: "https://autode.sk/3QkICWu", link_e: "https://autode.sk/4keX9kg" },
            { nome: "Predio Residencial de 10 pavimentos", descricao: "Arquitetura básica e projeto elétrico de um prédio com apartamentos típicos, garagem e cobertura", imagem: "assets/Prédio com 10 pavimentos.png", link: "https://autode.sk/4jqcxsE" },
            { nome: "Gerador Sustentável para Praça - Presidente Kenneddy - ES", descricao: "Projeto Conceitual de uma estrutura de gerador fotovoltaico utilizando os telhados de estruturas públicas e projeto de telhados solares de estacionamento ao redor da praça", imagem: "assets/Carport Kennedy.jpg", link: "https://autode.sk/42cMgIF"},
        ];
        ...
        projetos.forEach(projeto => {
            ...
            // Cria o HTML base do projeto
            let projetoHTML = `
                <h2>${projeto.nome}</h2>
                <p>${projeto.descricao}</p>
                <img src="${projeto.imagem}" alt="Imagem do ${projeto.nome}" class="exemplo-imagem">
                <a href="${projeto.link}" target="_blank" class="botao-link">Acessar Projeto 3D - Arquitetura</a>
            `;
    
            // Adiciona o botão de projeto elétrico apenas se existir um link_e
            if (projeto.link_e) {
                projetoHTML += `
                    <a href="${projeto.link_e}" target="_blank" class="botao-link">Acessar Projeto 3D - Elétrica</a>
                `;
            }
    
            divProjeto.innerHTML = projetoHTML;
